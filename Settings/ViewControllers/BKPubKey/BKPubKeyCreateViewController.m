...
HEADER:
        @"KEY",
ROWS:
        [@[@(ROW_ID_KEYTYPE), @(ROW_ID_BITS)] mutableCopy],
FOOTER:
        _typeFooterText
    };
    _commentsSection = @ {
...
ROWS:
        @[],
FOOTER:
        @"Blink creates PKCS#8 public and private keys, with AES 256 bit encryption. Use \"ssh-copy-id [name]\" to copy the public key to the server."
    };
