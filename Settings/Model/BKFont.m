...
+ (NSArray<BKFont *> *)_systemWideFonts {
  ...
  NSDictionary *traitsAttributes =
      @{UIFontSymbolicTrait : @(UIFontDescriptorTraitMonoSpace)};
  NSDictionary *fontAttributes =
      @{UIFontDescriptorTraitsAttribute : traitsAttributes};
  UIFontDescriptor *fontDescriptor =
      [UIFontDescriptor fontDescriptorWithFontAttributes:fontAttributes];
  NSArray *array =
...
- (NSString *)content {
  ...
  return [css stringByReplacingOccurrencesOfString:@"[[family]]"
...
- (BOOL)isEqual:(id)object {
  ...
  return [self isCustom] == [other isCustom] &&
