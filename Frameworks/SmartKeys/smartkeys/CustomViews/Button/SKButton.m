...
- (void)animatedButtonSelection:(BOOL)selected {
  if (selected) {
    ...
    self.backgroundLayer.frame =
        CGRectMake(2, 2, self.frame.size.width - 4, self.frame.size.height - 4);
    self.backgroundLayer.backgroundColor = [UIColor colorWithRed:86.0 / 255.0
                                                           green:234.0 / 255.0
                                                            blue:241.0 / 255.0
                                                           alpha:1.0]
                                               .CGColor;
