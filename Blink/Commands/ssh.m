...
void __thread_ssh_execute_command(const char *command, socket_t in,
                                  socket_t out) {
...
void __ssh_logging(int priority, const char *function, const char *buffer,
                   void *userdata) {
...
int ssh_main(int argc, char *argv[]) {
  ...
  SSHClient *client =
      [[SSHClient alloc] initWithStdIn:fileno(thread_stdin)
