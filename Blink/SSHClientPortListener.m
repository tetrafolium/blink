...
void _socketCallback(CFSocketRef s, CFSocketCallBackType type,
...
- (int)listen {
  ...
  struct sockaddr_in address = {
      .sin_family = AF_INET,
      .sin_addr.s_addr =
          INADDR_ANY, // TODO: inet_aton("<address>", &address.sin_addr.s_addr)
  ...
  _socketRef = CFSocketCreateWithNative(NULL, sock, kCFSocketAcceptCallBack,
                                        _socketCallback, &ctx);
