...
SSHOptionPort:
        @[portType, @(22)],
SSHOptionRequestTTY:
        @[yesNoAutoType, SSHOptionValueAUTO],
SSHOptionTCPKeepAlive:
        @[yesNoType, SSHOptionValueYES],
SSHOptionConnectionAttempts:
        @[intType, @(1)],
SSHOptionNumberOfPasswordPrompts:
        @[intType, @(3)],
SSHOptionServerAliveCountMax:
        @[intType, @(3)],
SSHOptionServerAliveInterval:
        @[intType, @(0)],
SSHOptionRemoteCommand:
        @[stringType],
SSHOptionConnectTimeout:
        @[intType, @(20) /*SSHOptionValueNONE*/],
SSHOptionIdentityFile:
        @[identityfileType, @[@"id_rsa", @"id_dsa", @"id_ecdsa", @"id_ed25519"]],
SSHOptionLocalForward:
        @[localforwardType],
SSHOptionRemoteForward:
        @[remoteforwardType],
SSHOptionProxyCommand:
        @[stringType],
SSHOptionForwardAgent:
        @[yesNoType, SSHOptionValueNO],
SSHOptionForwardX11:
        @[yesNoType, SSHOptionValueNO],
SSHOptionStrictHostKeyChecking:
        @[yesNoAskType, SSHOptionValueASK],
SSHOptionExitOnForwardFailure:
        @[yesNoType, SSHOptionValueNO],
SSHOptionSendEnv:
        @[sendEnvType], // LANG LC_* in os x ssh client
SSHOptionLogLevel:
        @[logLevelType, SSHOptionValueINFO],
SSHOptionCompression:
        @[yesNoType, SSHOptionValueYES], // We mobile terminal, so we set compression to yes by default.
SSHOptionCompressionLevel:
        @[compressionLevelType, @(6)], // Default compression for speed
SSHOptionSTDIOForwarding:
        @[hostportType],
SSHOptionPrintAddress:
        @[yesNoType, SSHOptionValueNO],

        // Auth
SSHOptionPubkeyAuthentication:
        @[yesNoType, SSHOptionValueYES],
SSHOptionKbdInteractiveAuthentication:
        @[yesNoType, SSHOptionValueYES],
SSHOptionPasswordAuthentication:
        @[yesNoType, SSHOptionValueYES],
SSHOptionIdentitiesOnly:
        @[yesNoType, SSHOptionValueNO]
    };
